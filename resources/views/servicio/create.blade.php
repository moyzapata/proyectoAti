        ...
        <div class="contact-wrapper animated bounceInUp">
            <div class="contact-form">
                ...
                <form action="/servicios" method="POST">
                    ...
                    <p>
                        <label>Nombre</label>
                        <input id="nombre" type="text" name="nombre" class="form-control" tabindex="1" required>
                    </p>
                    <p>
                        <label>Apellido</label>
                        <input id="apellido" type="text" name="apellido" class="form-control" tabindex="2" required>
                    </p>
                    <p>
                        <label>Correo Electronico</label>
                        <input id="correo" type="email" name="correo" class="form-control" tabindex="3" required>
                    </p>
                    <p>
                        <label>Dependencia/Institucion</label>
                        <input id="dependencia" type="text" name="dependencia" class="form-control" tabindex="4" required>
                    </p>
                    <p>
                        <label>Area</label>
                        <input id="area" type="text" name="area" class="form-control" tabindex="5" required>
                    </p>
                    <p>
                        <label>Domicilio</label>
                        <input id="domicilio" type="text" name="domicilio" class="form-control" tabindex="6" required>
                    </p>
                    <p>
                        <label>Numero de télefono</label>
                        <input id="telefono" type="telefono" name="telefono" class="form-control" tabindex="7" required>
                    </p> 
                    
                    <p>
                        <label>Marca/Equipo</label>
                        <input id="marca" type="text" name="marca" class="form-control" tabindex="9" required>
                    </p>  
                    <p>
                        <label>Numero/serie</label>
                        <input id="serie" type="text" name="serie" class="form-control" tabindex="10" required>
                    </p>   
                    <p>
                        <label>Factura</label>
                        <input id="factura" type="text" name="factura" class="form-control" tabindex="11" required>
                    </p>          
                    <p>
                       <label>Descripcion del detalle</label> 
                        <input id="falla" name="falla" class="form-control" tabindex="12" required>
                    </p>
                    <p class="block">
